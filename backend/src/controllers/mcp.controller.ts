...
import { featureTools } from '../tools/feature.tool.ts';
import { contactTools } from '../tools/contact.tool.ts';
...
export const mcpPostController = catchAsync(async (req: Request, res: Response) => {
    ...
    if (sessionId && transports[sessionId]) {
        ...
        registerMCPTools({ server, tools: [...userTools, ...featureTools, ...contactTools] });
